...
class UserSettingPageState extends State<UserSetting> {
 ...
 void _login() async {
  ...
  SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    var response = await http.get(
      Uri.parse(
        "http://wondrfly.com/api/users/getById/"+token,
      ),
    );
    var loginData = json.decode(response.body);
    print(loginData);
   _name.text=loginData['data']['firstName'];
_email.text=loginData['data']['email'];
  }
  @override
