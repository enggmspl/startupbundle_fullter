...
import 'package:startup_bundle_flutter/Screens/Auth/ResetPassword.dart';
...
class VerifyOtpPageState extends State<VerifyOtp> {
  ...
  mainAxisAlignment: MainAxisAlignment.center,
    ...
    child:  Text('Please enter the one time password send to your email',
